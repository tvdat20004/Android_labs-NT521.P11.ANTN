...
public abstract class p {
    ...
    public static final int[] f3978a = {R.attr.colorPrimary};

    /* renamed from: b, reason: collision with root package name */
    public static final int[] f3979b = {R.attr.colorPrimaryVariant};

    public static void a(Context context, AttributeSet attributeSet, int i, int i2) {
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, c.c.a.b.b.x, i, i2);
        boolean z = obtainStyledAttributes.getBoolean(1, false);
        obtainStyledAttributes.recycle();
        if (z) {
            TypedValue typedValue = new TypedValue();
            if (!context.getTheme().resolveAttribute(R.attr.isMaterialTheme, typedValue, true) || (typedValue.type == 18 && typedValue.data == 0)) {
                c(context, f3979b, "Theme.MaterialComponents");
            }
        }
        c(context, f3978a, "Theme.AppCompat");
    }
    ...
    */
    public static void b(android.content.Context r4, android.util.AttributeSet r5, int[] r6, int r7, int r8, int... r9) {
        ...
        L41:
            ...
            throw r4
        */
        throw new UnsupportedOperationException("Method not decompiled: c.c.a.b.p.p.b(android.content.Context, android.util.AttributeSet, int[], int, int, int[]):void");
    }
