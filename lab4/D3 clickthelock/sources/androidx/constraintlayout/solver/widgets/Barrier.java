    ...
    public void addToSolver(LinearSystem linearSystem) {
        ...
        for (int i7 = 0; i7 < this.mWidgetsCount; i7++) {
            ...
            if (this.mAllowsGoneWidget || constraintWidget2.allowedInBarrier()) {
                ...
                if (i9 == 0 || i9 == 2) {
                    linearSystem.addLowerBarrier(constraintAnchor.mSolverVariable, createObjectVariable, this.mMargin - i8, z);
                } else {
                    linearSystem.addGreaterBarrier(constraintAnchor.mSolverVariable, createObjectVariable, this.mMargin + i8, z);
                }
                linearSystem.addEquality(constraintAnchor.mSolverVariable, createObjectVariable, this.mMargin + i8, i6);
            }
        }
